...
code.overview.en = `
This component is a subcomponent of \`ModDialog\`, and the footer area places a ModButton (which can be customized) for confirmation. you also can customize the layout or styles of title, footer.
...
code.button.en = `
Customize the style of the button by \`buttonCustomStyle \`, but you can not change the position of the button (for example, let the button be right-aligned).
...
code.slot.en = `
Use \`title\`, \`footer\` slot to customize the style, \`footer\` for the confirmation of the button need add \`mod-confirm\` directive
